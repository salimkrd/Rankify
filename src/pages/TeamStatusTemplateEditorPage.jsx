      ...
      <main className="editor-grid">
        ...
        <section className="preview-panel">
          <div className="panel-title">
            <h2>Live Preview</h2>
            <p>Canvas: {template.canvas.width}×{template.canvas.height}px <span>Scaled to {Math.round(scale * 100)}%</span></p>
          </div>
          <div
          ...
          <section className="example-panel">
            <button type="button" onClick={() => setExampleOpen((open) => !open)}>
...
.editor-grid{display:grid;grid-template-columns:minmax(220px,242px) minmax(560px,1fr) minmax(340px,410px);gap:14px;padding:14px 18px 24px;align-items:start}
